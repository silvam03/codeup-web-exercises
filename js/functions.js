...
let tipPercent = prompt( "How much are you going to tip, please put amount is decimal form");
alert("Your tip amount should be $" + calculateTip(totalBill, tipPercent));

let tip = calculateTip(totalBill, tipPercent) + parseInt(totalBill);
alert("Your total amount plus the tip is $" + tip);
console.log(tip);
